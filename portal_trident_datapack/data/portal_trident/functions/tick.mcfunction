...
execute if score blueportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~1 ~3 ~ ~ ~1 ~ minecraft:blue_stained_glass_pane replace air
...
execute if score blueportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:blue_wool replace #flowers
execute if score blueportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:blue_wool replace grass
execute if score blueportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:blue_wool replace tall_grass
execute if score blueportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~1 ~3 ~ ~ ~1 ~ minecraft:blue_stained_glass_pane replace air
execute if score blueportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:blue_wool replace air
...
execute if score orangeportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~1 ~3 ~ ~ ~1 ~ minecraft:orange_stained_glass_pane replace air
...
execute if score orangeportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:orange_wool replace #flowers
execute if score orangeportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:orange_wool replace grass
execute if score orangeportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:orange_wool replace tall_grass
execute if score orangeportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~1 ~3 ~ ~ ~1 ~ minecraft:orange_stained_glass_pane replace air
execute if score orangeportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:orange_wool replace air
