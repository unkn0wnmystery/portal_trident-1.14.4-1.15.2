execute if score delay data matches 0 if score startdelay data matches 0 at @e[type=minecraft:armor_stand,nbt={Tags:["blue:1"]}] store result score startdelay data run tp @a[distance=..1] @e[type=minecraft:armor_stand,nbt={Tags:["orange:1"]},limit=1]
execute if score startdelay data matches 1 run scoreboard players operation delay data = delayby persistent
execute if score startdelay data matches 1 run scoreboard players set startdelay data 0
execute if score delay data matches 0 if score startdelay data matches 0 at @e[type=minecraft:armor_stand,nbt={Tags:["orange:1"]}] store result score startdelay data run tp @a[distance=..1] @e[type=minecraft:armor_stand,nbt={Tags:["blue:1"]},limit=1]
...
execute if score blueportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~1 ~3 ~ ~ ~1 ~ minecraft:blue_stained_glass_pane replace air
...
execute if score blueportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:blue_wool replace #flowers
execute if score blueportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:blue_wool replace grass
execute if score blueportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:blue_wool replace tall_grass
execute if score blueportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~1 ~3 ~ ~ ~1 ~ minecraft:blue_stained_glass_pane replace air
execute if score blueportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:blue_wool replace air
...
execute if score blueportal data matches 1 at @e[type=minecraft:armor_stand,nbt={Tags:["blue:1"]}] run forceload remove ~ ~
...
execute if score blueportal data matches 1 at @e[type=minecraft:armor_stand,nbt={Tags:["blue:1"]}] run forceload add ~ ~
...
execute if score orangeportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~1 ~3 ~ ~ ~1 ~ minecraft:orange_stained_glass_pane replace air
...
execute if score orangeportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:orange_wool replace #flowers
execute if score orangeportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:orange_wool replace grass
execute if score orangeportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:orange_wool replace tall_grass
execute if score orangeportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~1 ~3 ~ ~ ~1 ~ minecraft:orange_stained_glass_pane replace air
execute if score orangeportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:orange_wool replace air
...
execute if score orangeportal data matches 1 at @e[type=minecraft:armor_stand,nbt={Tags:["orange:1"]}] run forceload remove ~ ~
...
execute if score orangeportal data matches 1 at @e[type=minecraft:armor_stand,nbt={Tags:["orange:1"]}] run forceload add ~ ~
